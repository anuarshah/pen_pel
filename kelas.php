                        ...
                        <div class="panel-body">
                             <div class="table-sorting table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
                                    ...
                                    <tbody>
									<?php
									$sql = "select * from kelas, grade where grade.grade_id = kelas.grade_id and kelas.delete_status='0'";
									$q = $conn->query($sql);
									$i=1;
									while($r = $q->fetch_assoc())
									...
									echo '<tr>
                                            ...
                                            <td>'.$r['kelas'].'</td>
											<td>
											<a href="kelas.php?action=edit&kelas_id='.$r['kelas_id'].'" class="btn btn-success btn-xs" style="border-radius:60px;"><span class="glyphicon glyphicon-edit"></span></a>
											
											<a onclick="return confirm(\'Are you sure you want to delete this record\');" href="kelas.php?action=delete&kelas_id='.$r['kelas_id'].'" class="btn btn-danger btn-xs" style="border-radius:60px;"><span class="glyphicon glyphicon-remove"></span></a> </td>
                                        </tr>';
										$i++;
									}
									?>
