...
and fees_info.fi_grade_id = $gradeSelect
and student.kelas_id = $kelasSelect
...
and student.student_id = j01_year_student.student_id order by student.student_id desc";
                ...
                while($r = $q->fetch_assoc())
                {
                        echo '<tr>
                                            ...
                                            <a onclick="return confirm(\'Are you sure you want to deactivate this record\');" href="payment.php?action=delete&student_id='.$r['student_id'].'" class="btn btn-danger btn-xs" style="border-radius:3px;">&nbsp;&nbsp;<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;</a> </td>   
                                        </tr>';
