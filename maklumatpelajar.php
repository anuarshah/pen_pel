...
$grade = mysqli_real_escape_string($conn,$_POST['grade']);
 ...
 if($_POST['action']=="add")
 {
  ...
  $q1 = $conn->query("INSERT INTO student (sname, contact, no_mykid,no_cert_birth,dob,gender,joindate,grade,balance,fees) VALUES ('$sname','$contact','$no_mykid','$no_cert_birth','$dob','$gender','$joindate', '$grade','$balance','$fees')") ;
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
  $sql = $conn->query("UPDATE  student  SET  sname = '$sname', contact= '$contact', grade  = '$grade', no_mykid = '$no_mykid',no_cert_birth = '$no_cert_birth', dob = '$dob', joindate = '$joindate', gender = '$gender'  WHERE  id  = '$id'");
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Hal Ehwal Pelajar 
						<?php
...
<!--add by shahrul><-->
                  ...
                  <div class="row">
                    <div class="col-sm-5">
                      <!-- text input -->
                      <div class="form-group">
                          <label class="col-sm-8">Sesi</label>
                          <div class="col-sm-8">
             ...
             <div class="row">
                    <div class="col-sm-5">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-sm-8">
                          <input type="text" id='joindate' name='joindate' value="<?php echo $joindate;?>" class="form-control" >
                        </div>
                      </div>
                    </div>
             </div>
             ...
             <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
									<input type="text" class="form-control" placeholder="Tarikh Lahir" id="dob" name="dob" value="<?php echo  ($dob!='')?date("Y-m-d", strtotime($dob)):'';?>" style="background-color: #fff;" readonly />
						        </div>
                      </div>
                    </div>
                    <div class="col-sm-5">
            ...
            <div class="form-group">
                ...
                <input type="hidden" name="action" value="<?php echo $action;?>">
                  ...
                  <button type="submit" name="save" class="btn btn-success" style="border-radius:0%">Simpan Maklumat Pelajar</button>
  ...
  <li><a data-toggle="pill" href="#menu2">Maklumat Yuran</a></li>
</ul>
...
<div class="tab-content">
  ...
  <div id="menu1" class="tab-pane fade">
    <h3>Maklumat Ibubapa/Penjaga</h3>
               <div class="form-group">
                <div class="col-sm-4 col-sm-offset-2">
                <input type="hidden" name="id" value="<?php echo $id;?>">
                <input type="hidden" name="action" value="<?php echo $action;?>">
